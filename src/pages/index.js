...
export default function Home() {
  return (
    <main>
      ...
      <h1 className={`pt-28 text-9xl bg-clip-text text-transparent bg-gradient-to-t from-orange-500 via-red-500 bg-pink-500 w-full text-center animate-shadow-pulse drop-shadow-[0_0px_5px_rgba(255,255,255,0.5)] ${airstikeOutlineRegular .className}`}>COMP HAX</h1>
